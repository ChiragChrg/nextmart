...
const GroceriesSVG = ({ width = "100%", height = "100%", className = "" }: Props) => {
    return (
        <svg
        ...
        >
            <path fill="#1f1d35" d="M250.367 723.942H769.924V726.183H250.367z"></path>
            <path
                fill="#a0616a"
                d="M672.962 342.882a11.02 11.02 0 01-2.155 16.226l-53.77 36.917-23.677 15.785a6.51 6.51 0 01-8.649-1.295 6.51 6.51 0 011.77-9.75l22.933-13.317 40.023-38.117-25.73-27.635 19.06-14.294z"
            ></path>
            <path
                fill="#a0616a"
                d="M546.52 690.482L533.367 690.482 525.555 581.847 558.908 580.894 546.52 690.482z"
            ></path>
            <path
                fill="#1f1d35"
            ...
            <path
                fill="#a0616a"
                d="M634.096 690.482L620.943 690.482 613.131 581.847 647.437 575.177 634.096 690.482z"
            ></path>
            <path
                fill="#1f1d35"
            ...
            ></path>
            <circle cx="581.779" cy="218.779" r="28.588" fill="#a0616a"></circle>
            <path
                fill="#a0616a"
                d="M613.225 269.284L577.967 271.19 572.249 239.743 600.837 234.979 613.225 269.284z"
            ></path>
            <path
                fill="#007bff"
            ...
            ></path>
            <path fill="hsl(var(--border))" d="M58.445 110.234H304.445V321.234H58.445z"></path>
            <circle cx="131.445" cy="347.234" r="18" fill="#007bff"></circle>
            <path
                fill="#fff"
                d="M140.445 345.734L132.945 345.734 132.945 338.234 129.945 338.234 129.945 345.734 122.445 345.734 122.445 348.734 129.945 348.734 129.945 356.234 132.945 356.234 132.945 348.734 140.445 348.734 140.445 345.734z"
            ></path>
            <circle cx="226.445" cy="347.234" r="18" fill="#007bff"></circle>
            <path
                fill="#fff"
                d="M439.983 424.345H442.983V442.345H439.983z"
                transform="rotate(90 377.02 282.77)"
            ></path>
            <path
                fill="#007bff"
            ...
            <path
                fill="hsl(var(--border))"
                d="M58.445 407.234H304.445V618.2339999999999H58.445z"
            ></path>
            <circle cx="131.445" cy="644.234" r="18" fill="#007bff"></circle>
            <path
                fill="#fff"
                d="M140.445 642.734L132.945 642.734 132.945 635.234 129.945 635.234 129.945 642.734 122.445 642.734 122.445 645.734 129.945 645.734 129.945 653.234 132.945 653.234 132.945 645.734 140.445 645.734 140.445 642.734z"
            ></path>
            <circle cx="226.445" cy="644.234" r="18" fill="#007bff"></circle>
            <path
                fill="#fff"
                d="M439.983 721.345H442.983V739.345H439.983z"
                transform="rotate(90 377.02 579.77)"
            ></path>
            <path
                fill="#fff"
                d="M229.873 557.131h.135a23.04 23.04 0 0021.573-14.45 75.416 75.416 0 10-100.465 41.31 22.843 22.843 0 0025.37-4.704 75.167 75.167 0 0153.387-22.156z"
            ></path>
            <circle cx="191.13" cy="509.395" r="24.906" fill="#f9a825"></circle>
        </svg>
    )
}
