...
const MultiImageDropzone = React.forwardRef<HTMLInputElement, InputProps>(
    (
        { dropzoneOptions, value, className, disabled, onChange, onFilesAdded, setFileStates, uploadFiles, isUploadComplete },
        ref
    ) => {
        ...
        return (
            <div className='w-full'>
                ...
                {(!value || value.length < (dropzoneOptions?.maxFiles ?? 0)) && (
                    ...
                    >
                        ...
                        <div className="flex flex-col items-center justify-center text-xs text-gray-400">
                            ...
                            <div className="mt-3">
                                <ButtonFileSelect type="button" disabled={disabled}>
                                    select
                                </ButtonFileSelect>
                            </div>
                        </div>
                ...
                {/* Upload Button */}
                {disableUploadButton ?
                    <Button disabled={true} className='w-full flex_center gap-4 bg-secondaryClr text-black hover:bg-secondaryClr_Alt mt-4 disabled:opacity-80'>
                        {isUploadComplete ?
                            <>
                                <CheckCircleIcon className='text-primaryClr' />
                                <span>Upload Complete</span>
                            </>
                            :
                            <>
                                <LoaderIcon className='w-fit' />
                    ...
                    <Button
                        ...
                        className='w-full flex_center gap-4 bg-primaryClr text-white hover:bg-primaryClr_Alt mt-4'>
                        <ImageUpIcon />
                        <span>Upload</span>
                    </Button>
                }
...
const ButtonFileSelect = React.forwardRef<
    HTMLButtonElement,
...
ButtonFileSelect.displayName = 'ButtonFileSelect';
