...
const Search = () => {
    ...
    return (
        <div className="bg-secondaryClr sm:min-w-[500px] max-w-[600px] relative w-full h-fit rounded flex gap-4 p-1 border border-secondaryClr">
            {/* Category Button */}
            ...
            {/* Search Input */}
            <form className="relative flex flex-grow flex-col justify-center" onSubmit={handleSearch}>
                <input
                    ref={searchInputRef}
                    type="text"
                    className="w-full sm:min-w-[300px] bg-secondaryClr p-1 px-2 outline-none"
            ...
            {/* Search Button */}
            <Button onClick={searchProducts} className="hidden lg:flex justify-center items-center bg-primaryClr gap-2 p-1 px-2 rounded text-white cursor-pointer">
