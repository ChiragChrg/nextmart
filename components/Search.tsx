...
const Search = () => {
    ...
    return (
        <div className="bg-baseClr relative min-w-[400px] max-w-[600px] w-full h-fit rounded flex gap-4 p-1 border border-secondaryClr">
            {/* Category Button */}
            ...
            <form className="relative flex flex-grow flex-col bg-black" onSubmit={HandleSearch}>
                <input
                    type="text"
                    className="w-full min-w-[300px] bg-baseClr p-1 px-2 outline-none"
